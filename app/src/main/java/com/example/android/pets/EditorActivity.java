...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /** Content URI for existing pet (null if its's a new pet) */
    ...
    /**
     * OnTouchListener that listens ofr any user touches on a View, implying that they are modifying
     ...
     * updated (some menu items can be hidden or made visible).
     */
    @Override
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            // Then call setSelection() so that is displayed on screen as the current selection.
            switch (gender) {
    ...
    private void deletePet() {
        // Ony perform the delete if this is an existing pet.
        if (mCurrentPetUri != null) {
